...
os.chdir(Path to Step 4 Folder) # Path to Step 4 Folder 
...
# Service region landcover fraction  - NLCD urban landclass 
...
monthly_irrigation_depths.to_csv('Provider_outdoor_properties.csv') # only needs to be output once 
